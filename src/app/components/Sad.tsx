const SadIcon = (props: any) => (
  ...
  >
    ...
    <path d="M8.5 9a1.5 1.5 0 1 0 0 3 1.5 1.5 0 1 0 0-3M15.5 9c-.83 0-1.5.67-1.5 1.5s.67 1.5 1.5 1.5 1.5-.67 1.5-1.5S16.33 9 15.5 9M12 14c-3 0-4 3-4 3h8s-1-3-4-3"></path>
